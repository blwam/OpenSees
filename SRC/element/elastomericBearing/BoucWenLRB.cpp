...
void* OPS_BoucWenLRB()
{
    ...
    double E2 = 0.0035;                     // shape parameter of lead core heating
    ...
    double c2 = 1.5;                        // parameter controls initial hardening
    double c3 = 1.5;                        // parameter controls initial hardening
...
BoucWenLRB::BoucWenLRB()
    ...
    gamma2(-0.173), c1(1.8E-11),
    flagLH(0),
    E2(0.0035), rhoL(11200),
    cL(130), kS(50),
