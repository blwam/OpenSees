...
// Created: 2024/04/11
// Description:
// This file defines the BoucWenLRB element class, developed to model
// lead rubber bearings (LRBs) incorporating key nonlinear behaviors,
// including initial hardening, large strain stiffening, degradation,
// and strength reduction caused by lead core heating.
...
public:
    ...
    BoucWenLRB(int eleTag, int Nd1, int Nd2,
        ...
        double gamma2 = -0.173, double c1 = 1.8E-2,
        int flagLH = 0,
        double E2 = 0.0035, double rhoL = 11200.0,
        double cL = 130.0, double kS = 50.0,
        double alphaS = 1.41E-05, double TL0 = 20.0,
        int flagIH = 0,
        double c2 = 1.5, double c3 = 1.5,
...
private:
    ...
    int flagLH;                         // Boolean flag to control whether lead core heating is enabled (1) or disabled (0)
    ...
    int flagIH;                         // Boolean flag to control whether initial hardening is enabled (1) or disabled (0)
    ...
    double DMplus, DMminus, DM;         // parameters of degradation
    ...
    double DMplusC, DMminusC, DMC;      // parameters of degradation
