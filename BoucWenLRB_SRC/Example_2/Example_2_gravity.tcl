...
set kInit 8.5E6
set qYield0 68.1E3
set alphaL 0.091;  # Post-yield stiffness ratio
set dL 100e-03;  # Inner diameter of bearing
set D2 600e-03;  # Outer diameter of bearing
set ts 4e-03;  # Single steel shim thickness
set tr 5.5e-03;  # Single rubber layer thickness
...
set M [expr 3e6*$pi*$D2*$D2/$g];  # Mass of superstructure (12MPa)
...
uniaxialMaterial Elastic 7 200000000;  # 10% vertical stiffness
uniaxialMaterial ENT 8 1800000000;  # 90% vertical stiffness
